...
def authorization():
    global see_code, auth_code, auth_condition
    see_code = True
    with auth_condition:
        auth_condition.wait()
...
def captcha_handler(captcha):
    global see_captcha, captcha_sid, captcha_url, captcha_key, captcha_condition
    see_captcha = True
...
def login_to_acc(login, password):
    global vk_audio, user_id, see_login, see_code, see_captcha, vk_session, vk, user_info, user_id
    see_login = False
    try:
...
def index(q=None):
    ...
    global see_code, see_captcha, see_login, vk_audio
    if see_login:
...
def captcha():
    global captcha_key, see_captcha, captcha_url, captcha_condition
...
def auth_code():
    global auth_code, see_code, auth_condition
